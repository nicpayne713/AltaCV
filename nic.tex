...
\cvevent{Sr. Data Scientist}{Group: Remanufacturing}{February 2021-Present}{Remote}

\begin{ itemize }
\item  Build ETL pipeline solutions built with Python and Kedro targeting Docker deployment on AWS Batch with Snowflake and S3 data stores
